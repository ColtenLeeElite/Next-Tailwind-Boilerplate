            ...
            >
              ...
              <div className="flex flex-col items-center justify-center mt-7">
                <div className="flex flex-row items-center w-full">
                  <div className="w-full h-0 border-b border-gray-400" />
                  <span className="ml-3 mr-3 text-sm font-normal text-gray-400">
                    or
                  </span>
                  <div className="w-full h-0 border-b border-gray-400" />
                </div>
              ...
              <div className="flex flex-col items-center justify-center gap-2 mt-7">
                <div
                  className="flex flex-row items-center justify-center w-full gap-3 px-2 py-3 border border-gray-800 rounded-xl hover:cursor-pointer"
                  onClick={loginGoogle}
                >
